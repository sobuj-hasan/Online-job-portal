<?php 
include ('header.php');
// include ('company/check-login.php');

  $personal_cv_id = htmlspecialchars($_GET['personal_cv_id']);
  // Personal user CV infomation 
  $select_query = "SELECT * FROM user_cv WHERE ucv_id = $personal_cv_id";
