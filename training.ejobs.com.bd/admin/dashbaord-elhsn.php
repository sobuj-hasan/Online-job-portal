                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <h4><?php echo $stadm_today = student_count_author('Admin','today_admission') ;
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <h4><?php echo $stadm_today_form = student_count_author('Admin','today_form') ;
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <h4><?php echo $stadm_today_form = student_count_author('Admin','admission_this_month') ;
													//$stadm_today_form_persent = round($stadm_today_form*100/$stmax);
													?></h4>
                                                        <div>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        ...
                                                        <h4><?php echo  $stadm_tot_adm = student_count_author('Admin','all') ;
