...
<section class="error-404 not-found">
	...
	<div class="page-content si-entry">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="si-btn btn-left-icon btn-reveal" role="button"><span><?php esc_html_e( 'Return to Home', 'sinatra' ); ?></span><i class="si-icon si-arrow-left" aria-hidden="true"></i></a>
	</div><!-- .page-content -->
