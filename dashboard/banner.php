        ...
        <div class="row icon-main mt-5">
            ...
            ?>
             <div class="col-md-2 col-sm-6 col-xs-6 fs">
                ...
                <h6 class="mt-3 font-weight-bold cs-t">জব খুঁজছেন</h6>
            </div>
           ...
           <div class="col-md-2 col-sm-6 col-xs-6 fs">
                ...
                <h6 class="mt-3 font-weight-bold cs-t">টোটাল সিভি</h6>
            </div>
            ...
            ?>
             <div class="col-md-2 col-sm-6 col-xs-6 fs">
                ...
                <h6 class="mt-3 font-weight-bold cs-t">টোটাল জব</h6>
            </div>
              <div class="col-md-2 col-sm-6 col-xs-6 fs">
                <span class="fs" aria-hidden="true"> <?php echo $cjp_info->num_rows + $live_job; ?> </span>
                <h6 class="mt-3 font-weight-bold cs-t">লাইভ জব </h6>
            </div>
              <div class="col-md-2 col-sm-6 col-xs-0 fs">
      ...
      <div class="form-wrap">
        ...
        <form action="" method="POST">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="input-group">
                <select class="form-control custome-select" class="dropdown" name="city_name">
            ...
            <div class="col-md-3">
              <div class="input-group">
                <select class="form-control custome-select" name="job_category">
