...
include ('header.php');
  ...
  $select_query = "SELECT * FROM all_company WHERE ac_cmp_status = 'pending' ORDER BY ac_id DESC LIMIT $start_from,$num_per_page";
                 ...
                 <div class="card-body">
                     <div class="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                       ...
                       <div class="wrapper text-center text-sm-left">
                         <p class="card-text mb-0"><a href="total-users.php" style="text-decoration:none;">Pending Company</a></p>
               ...
               <div class="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                 <div class="card-body">
                     <div class="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                       ...
                       <div class="wrapper text-center text-sm-left">
                         <p class="card-text mb-0"><a href="total-shops.php" style="text-decoration:none;">Approval Pending</a></p>
                         <div class="fluid-container">
                           <h3 class="card-title mb-0"><?=$company_info->num_rows;?></h3>
                         </div>
                       </div>
              ...
              <div class="card">
                <div class="card-body">
                  <form action="" method="POST">
                    <h4 class="card-title">Approval Pending Company:</h4>
                      ...
                      <form action="" method="POST">
                        <?php
                          if (isset($_POST['submit'])) {
                            ...
                            $select_query = "SELECT * FROM `all_company` WHERE ac_cmp_status == 'pending' AND ac_cmp_name LIKE '$search_value' OR ac_cmp_phone LIKE '$search_value'";
                            $company_info = mysqli_query($np2con, $select_query);
                          }
                        ?>
                    ...
                    <div class="row">
                      <div class="col-12 table-responsive">
                            ...
                            foreach ($pagi_info as $company_single_info) {
                               ...
                               <tbody>
                                  <tr>
                                     ...
                                     <td>
                                       <label class="badge badge-danger p-2"><?=$company_single_info['ac_cmp_status'];?> </label>
                                     </td>
                        ...
                        <ul class="pagination mt-4">
                            <?php
                              $per_query = "SELECT * FROM all_company WHERE ac_cmp_status = 'pending'";
                              ...
                              if ($page>1) {
                                ?>
                                  <li class="page-item">
                                    <a class="page-link" href="pending-company.php?page=<?=$page-1;?>"><i class="mdi mdi-chevron-left"></i></a>
                                  </li>
                                <?php
                              }
                              ...
                              for ($i=1; $i < $total_page ; $i++) { 
                                ...
                                ?>
                                  <li class="page-item <?php echo ($i == $page ? "active" : "") ?>">
                                    <a class="page-link" href="pending-company.php?page=<?=$i;?>"><?=$i;?></a>
                                  </li>
                                <?php
                              }
                              ...
                              if ($i>$page) {
                                ?>
                                  <li class="page-item">
                                    <a class="page-link" href="pending-company.php?page=<?=$page+1;?>"><i class="mdi mdi-chevron-right"></i></a>
                                  </li>
                                <?php
                              }
