...
?>
  ...
  <div class="featured-wrap">
    <div class="container">
      <div class="heading-title">All Featured <span>Jobs</span></div>
    ...
    <!-- <div class="read-btn"><a href="#" onchange="">View More Jobs</a></div> -->
  </div>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7 col-sm-6 pull-right"> 
        ...
        <div class="appbtn">
          <div class="row">
            <div class="col-md-5 col-sm-6 col-xs-6"><a href="#."><img src="images/apple.png" alt=""></a></div>
            <div class="col-md-5 col-sm-6 col-xs-6"><a href="#."><img src="images/andriod.png" alt=""></a></div>
          </div>
        </div>
        <!--app info end--> 
      </div>
