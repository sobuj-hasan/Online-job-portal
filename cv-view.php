...
include ('header.php');
  ...
  $select_query = "SELECT * FROM user_cv WHERE ucv_id = $ucv_id";
                                                        ...
                                                        <div id="resume">
                                                            ...
                                                            <div class="box">
                                                                ...
                                                                <div class="box-cell box1">
                                                                    ...
                                                                    <div class="BDJNormalText04"><strong>Mobile No 1: 01XXXXXXXXX</strong></div>
                                                                    <?php
                                                                        if ($ucv_info['ucv_phone_two']) {
                                                                            ?>
                                                                            <div class="BDJNormalText04"><strong>Mobile No 2: 01XXXXXXXXX</strong></div>
                                                                            <?php
                                                                        }
                                                                    ?>
                                                                    <?php
                                                                        if($ucv_info['ucv_email']){
                                                                            ?>
                                                                            <div class="BDJNormalText04"><strong>E-mail : XXXXXXXX@gmail.com</strong></div>
                                                                            <?php
                                                                        }
                                                                    ?>
                                                                </div>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <th width="750" colspan="5" align="left" class="BDJBoldText01">
                                                                                    <span>
                                                                                        <?php
                                                                                            $date = DateTime::createFromFormat('Y-m-d', $ucv_info['ucv_start_period_month_one']);
                                                                                            $deadline = DateTime::createFromFormat('Y-m-d', $ucv_info['ucv_end_period_month_one']);

                                                                                            echo $ucv_info['ucv_designation_one'];
                                                                                        ?>
                                                                                        &nbsp;&nbsp; <?=$date->format('M Y');?>
                                                                                         - 
                                                                                        <?php
                                                                                            if ($ucv_info['ucv_current_work_one'] == 1){
                                                                                                echo "Continue"; 
                                                                                            }else{
                                                                                                echo $deadline->format('M Y');
                                                                                            } 
                                                                                        ?>
                                                                                    </span>
                                                                                </th>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <th width="750" colspan="5" align="left" class="BDJBoldText01">
                                                                                    <span>
                                                                                        <?php
                                                                                            $date = DateTime::createFromFormat('Y-m-d', $ucv_info['ucv_start_period_month_two']);
                                                                                            $deadline = DateTime::createFromFormat('Y-m-d', $ucv_info['ucv_end_period_month_two']);

                                                                                            echo $ucv_info['ucv_designation_two'];
                                                                                        ?>
                                                                                        &nbsp;&nbsp; <?=$date->format('M Y');?>
                                                                                         - 
                                                                                        <?php
                                                                                            if ($ucv_info['ucv_current_work_two'] == 1){
                                                                                                echo "Continue"; 
                                                                                            }else{
                                                                                                echo $deadline->format('M Y');
                                                                                            } 
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php
                                                                    if ($ucv_info['ucv_exp1_one']) {
                                                                        ...
                                                                        <?php
                                                                    }elseif ($ucv_info['ucv_edu_achieve_two']) {
                                                                        ?>
                                                                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="750" style="margin-top: 10px; margin-bottom: 10px;">
                                                                            <caption class="sr-only">Specialization table</caption>
                                                                            <tbody>
                                                                        ...
                                                                        <?php
                                                                    }elseif ($ucv_info['ucv_edu_achieve_one']) {
                                                                        ?>
                                                                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="750" style="margin-top: 10px; margin-bottom: 10px;">
                                                                            <caption class="sr-only">Specialization table</caption>
                                                                            <tbody>
